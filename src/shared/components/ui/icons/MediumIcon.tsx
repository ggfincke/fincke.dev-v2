// src/shared/components/ui/icons/MediumIcon.tsx
// Medium logo icon (inlined SVG path from simple-icons)
...
// Medium logo SVG
export function MediumIcon({ size, className }: MediumIconProps)
{
  return <BrandIcon path={MEDIUM_PATH} size={size} className={className} />
}
