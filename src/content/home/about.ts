...
export const ABOUT_CONTENT = deepFreeze({
  heading: 'About',
  paragraphs: [
    "I'm a full-stack engineer focused on AI infrastructure and retrieval systems. I'm currently a Software Developer Intern at Westinghouse building FastAPI services for agent-grounded document retrieval, after a year at Scale AI building Python evaluation harnesses for LLM-generated code. I work mostly in Python and TypeScript: FastAPI/Django/Node.js + Postgres on the backend, React/Next.js on the web, and SwiftUI/UIKit for native iOS/watchOS, with Docker, GitHub Actions, and AWS for CI/CD and ops.",
