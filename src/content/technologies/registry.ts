...
const TECHNOLOGIES = [
  ...
  { id: 'agent-skills', label: 'Agent Skills', category: 'tooling' },
  {
    id: 'anthropic',
    label: 'Anthropic',
    category: 'data',
  ...
  { id: 'dompurify', label: 'DOMPurify', category: 'tooling' },
  { id: 'durable-objects', label: 'Durable Objects', category: 'infra' },
  {
  ...
  { id: 'graphviz', label: 'Graphviz', category: 'tooling' },
  ...
  { id: 'json-schema', label: 'JSON Schema', category: 'tooling' },
  ...
  { id: 'markdown', label: 'Markdown', category: 'tooling' },
  ...
  { id: 'openapi', label: 'OpenAPI', category: 'tooling' },
  ...
  { id: 'oracle', label: 'Oracle', category: 'infra' },
  ...
  { id: 'plantuml', label: 'PlantUML', category: 'tooling' },
  ...
  { id: 'pydantic', label: 'Pydantic', category: 'framework' },
  { id: 'pytest', label: 'pytest', category: 'tooling' },
  ...
  { id: 'scratch', label: 'Scratch', category: 'platform' },
  { id: 'seaborn', label: 'seaborn', category: 'data' },
  { id: 'selenium', label: 'Selenium', category: 'tooling' },
  { id: 'semaphores', label: 'Semaphores', category: 'platform' },
  ...
  { id: 'unified', label: 'Unified', category: 'framework' },
  { id: 'verilog', label: 'Verilog', category: 'language' },
  { id: 'virtual-memory', label: 'Virtual Memory', category: 'platform' },
  ...
  { id: 'workers-ai', label: 'Workers AI', category: 'data' },
  { id: 'x86-64', label: 'x86-64', category: 'platform' },
